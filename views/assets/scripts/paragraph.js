let boxAddParagraphDefault = document.querySelector(".box_add_paragraph");
const containerOtherParagraphs = document.querySelector(".container_other_paragraphs");
let currentParagraph = 1;

boxAddParagraphDefault.onclick = function() {
...
function removeBoxParagraph() {
    ...
    let paragraphs = document.querySelectorAll(".container_other_paragraphs .box_paragraph");
    ...
    if(paragraphs.length >= 1) {
        ...
        boxAddParagraphDefault.style.display = "block";
    }
...
function removeActionButtons() {
    ...
    let boxAdd = document.querySelector(".box_add_paragraph_new");
    if(boxAdd) {
        boxAdd.remove();
    }
...
function addActionButtons() {
    let boxRemoveParagraph = document.querySelector(".box_remove_paragraph");
    boxRemoveParagraph.addEventListener("click", removeBoxParagraph);
    
    let newBoxAdd = document.querySelector(".box_add_paragraph_new");
    newBoxAdd.addEventListener("click", addNewParagraph);
}