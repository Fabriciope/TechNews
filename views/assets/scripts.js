...
function addActionButtons(){let buttonsRemoveParagraph=document.querySelectorAll(".btn_remove_paragraph");if(buttonsRemoveParagraph){buttonsRemoveParagraph.forEach(button=>{button.addEventListener("click",removeBoxParagraph)})}
